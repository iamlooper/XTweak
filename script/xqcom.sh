...
case "$target" in "bengal")
  ...
  case "$soc_id" in "441" | "471" | "473" | "474" )
    echo "0" >/sys/devices/system/cpu/cpu0/core_ctl/enable
    echo "0" >/sys/devices/system/cpu/cpu0/cpufreq/schedutil/up_rate_limit_us
    echo "0" >/sys/devices/system/cpu/cpu0/cpufreq/schedutil/down_rate_limit_us
    echo "1305600" >/sys/devices/system/cpu/cpu0/cpufreq/schedutil/hispeed_freq
...
"msm8974")
  ...
  echo "512" >/sys/block/mmcblk0/bdi/read_ahead_kb
  ;;
"msm8909" | "msm8916" | "msm8937" | "msm8952" | "msm8953" | "msm8994" | "msm8992" | "msm8996" | "msm8998" | "sdm660" | "apq8098_latv" | "sdm845" | "sdm710" | "qcs605" | "msmnile" | "sdmshrike" | "msmsteppe" | "sm6150" | "kona" | "lito" | "trinket" | "atoll" | "bengal" | "sdmshrike")
